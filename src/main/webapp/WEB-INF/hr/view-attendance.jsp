            ...
            <div class="flex flex-col w-64 bg-white border-r border-gray-200">
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <div class="space-y-4">
                        ...
                        <a href="${pageContext.request.contextPath}/hr/attendance/view" class="flex items-center px-2 py-2 text-sm font-medium text-white bg-primary-600 rounded-md group">
