                ...
                <div class="mt-8 w-full">
                    ...
                    <div class="mt-10 mb-12 bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
                        ...
                        <div class="p-6 text-center">
                            <p class="text-gray-500 dark:text-gray-400">Leave analytics visualization has been temporarily disabled.</p>
                            <p class="text-gray-500 dark:text-gray-400 mt-2">Please check back later for updated information.</p>
                        </div>
                    </div>
                </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Leave Analytics code removed as it's not required
    });
</script>
</c:set>
