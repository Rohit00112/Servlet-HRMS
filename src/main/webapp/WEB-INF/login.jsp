        ...
        <div class="w-full max-w-md">
            ...
            <c:if test="${not empty sessionScope.message && sessionScope.messageType == 'success'}">
                <div class="mb-6 bg-green-50 border-l-4 border-green-500 text-green-700 p-4 rounded-r-md" role="alert">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm">${sessionScope.message}</p>
                        </div>
                    </div>
                </div>
            ...
            <form action="login" method="post" class="space-y-6">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="${pageContext.request.contextPath}/forgot-password" class="font-medium text-primary-600 hover:text-primary-500 dark:text-primary-400 dark:hover:text-primary-300">Forgot your password?</a>
                    </div>
                </div>
