...
<c:set var="mainContent">
    ...
    <div class="flex justify-end mb-4">
        <a href="${pageContext.request.contextPath}/hr/payroll/generate" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                            ...
                            <c:forEach var="payroll" items="${payrolls}">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        ...
                                        <a href="${pageContext.request.contextPath}/hr/payroll/download?id=${payroll.id}" class="text-primary-600 hover:text-primary-900">Download</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
