...
<c:set var="mainContentHtml">
    <div class="flex justify-between items-center">
        ...
        <jsp:include page="/WEB-INF/components/button.jsp">
            ...
            <jsp:param name="url" value="/hr/employees/add" />
        </jsp:include>
    </div>

    <!-- Search Form -->
    <jsp:include page="/WEB-INF/components/search-form.jsp">
        <jsp:param name="searchUrl" value="/hr/employees" />
        <jsp:param name="searchPlaceholder" value="Search employees..." />
    </jsp:include>

    <!-- Employee Table -->
    <c:set var="tableContent">
    ...
    <jsp:include page="/WEB-INF/components/table.jsp">
        ...
        <jsp:param name="tableContent" value="${tableContent}" />
    </jsp:include>
    ...
    <div class="mt-8 w-full">
        <jsp:include page="/WEB-INF/components/recent-activities.jsp">
            <jsp:param name="title" value="Recent Employee Activities" />
            <jsp:param name="entityType" value="EMPLOYEE" />
...
<jsp:include page="/WEB-INF/components/layout.jsp">
    ...
    <jsp:param name="mainContent" value="${mainContentHtml}" />
