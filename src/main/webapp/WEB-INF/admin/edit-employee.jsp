                    ...
                    <div class="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                        <form action="${pageContext.request.contextPath}/admin/employees/edit" method="post" class="p-6" id="employeeForm">
                                    ...
                                    <div class="mt-1">
                                        <select id="designationId" name="designationId" required class="shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm border-gray-300 rounded-md">
                                            ...
                                            <c:forEach var="designation" items="${designations}">
                                                <option value="${designation.id}" ${designation.id == employee.designationId ? 'selected' : ''}>${designation.title}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mt-6 flex justify-end">
                                <a href="${pageContext.request.contextPath}/admin/employees" class="inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-md shadow-sm text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 mr-3">
                                    Cancel
                                </a>
