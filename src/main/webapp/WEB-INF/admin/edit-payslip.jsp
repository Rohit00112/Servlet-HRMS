...
<c:set var="backUrl" value="/admin/payroll/view?id=${payroll.id}" scope="request" />
...
<c:set var="mainContent">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="mt-6 bg-white dark:bg-gray-800 shadow-lg overflow-hidden sm:rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <form action="${pageContext.request.contextPath}/admin/payroll/generate" method="post" class="p-6">
                ...
                <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-6 flex justify-end space-x-3">
                        <a href="${pageContext.request.contextPath}/admin/payroll/view?id=${payroll.id}" class="inline-flex items-center px-4 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                            Cancel
                        </a>
