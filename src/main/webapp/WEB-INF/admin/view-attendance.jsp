            ...
            <div class="flex flex-col w-64 bg-white border-r border-gray-200">
                ...
                <div class="flex flex-col flex-grow px-4 py-4 overflow-y-auto">
                    <div class="space-y-4">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/attendance/view" class="flex items-center px-2 py-2 text-sm font-medium text-white bg-primary-600 rounded-md group">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    ...
                    <div class="mt-6 bg-white shadow overflow-hidden sm:rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <form action="${pageContext.request.contextPath}/admin/attendance/view" method="get" class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                                <!-- Employee Filter -->
