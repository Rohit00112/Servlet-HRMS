...
<body class="bg-gray-50 min-h-screen">
            ...
            <main class="flex-1 overflow-y-auto py-6 px-6">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                    <div class="flex justify-between items-center">
                        ...
                        <a href="${pageContext.request.contextPath}/hr/employees/add" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-primary-600 hover:bg-primary-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500">
                    ...
                    <!-- Search Form -->
                    <div class="mt-6">
                        <form action="${pageContext.request.contextPath}/hr/employees" method="get" class="flex w-full md:w-1/2 space-x-2">
                            <div class="flex-grow">
                                        ...
                                        <c:forEach var="employee" items="${employees}">
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="${pageContext.request.contextPath}/hr/employees/edit?id=${employee.id}" class="text-primary-600 hover:text-primary-900 mr-4">Edit</a>
    ...
    <script>
        function confirmDelete(employeeId) {
            ...
            confirmBtn.href = '${pageContext.request.contextPath}/hr/employees/delete?id=' + employeeId;
        }
